...
output "web_app_identity_principal_id" {
  value       = azurerm_linux_web_app.linux_web_app.identity.0.principal_id #block
  description = "The Principal ID associated with this Managed Service Identity."
}

output "web_app_identity_tenant_id" {
  value       = azurerm_linux_web_app.linux_web_app.identity.0.tenant_id #block
...
output "web_app_site_credential_username" {
  value       = azurerm_linux_web_app.linux_web_app.site_credential.0.name #block
  description = "The Site Credentials Username used for publishing."
}

output "web_app_site_credential_password" {
  value       = azurerm_linux_web_app.linux_web_app.site_credential.0.password #block
