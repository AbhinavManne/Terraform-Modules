...
variable "servicebus_namespace_disaster_recovery_config_name" {
  type        = string
  description = "Specifies the name of the Disaster Recovery Config. This is the alias DNS name that will be created. Changing this forces a new resource to be created."
}

variable "primary_servicebus_namespace_name" {
  type        = string
  description = "Name of the primary Service Bus Namespace"
}

variable "secondary_servicebus_namespace_name" {
  type        = string
  description = "Name of the Service Bus Namespace to be replicated to."
}

variable "primary_servicebus_namespace_location" {
  type        = string
  description = "Specifies the resource group location for the primary Service Bus Namespace."
}

variable "secondary_servicebus_namespace_location" {
  type        = string
  description = "Specifies the resource group location for the Service Bus Namespace to be replicated to."
}
