...
existed_public_key            = null
generate_ssh_key              = true

ssh_key_algorithm       = "RSA"
ssh_key_rsa_bits        = 4096
private_key_secret_name = "ssh-key-15"
key_vault_id            = "/subscriptions/2a24fef9-dc44-4a62-a3a6-001ade556497/resourceGroups/vmssw/providers/Microsoft.KeyVault/vaults/kv-174" #"/subscriptions/dcd2c118-9f88-4a53-8b1b-fbc235ad0bef/resourceGroups/common_rg/providers/Microsoft.KeyVault/vaults/kv-739"
secret_content_type     = "text"
secret_expiration_date  = "2022-12-31T00:00:00Z"
secret_not_before_date  = null
password_secret_name    = "linux-vmss-pass"
...
diff_disk_settings_placement                      = "CacheDisk"
...
source_image_id                = null #"/subscriptions/2a24fef9-dc44-4a62-a3a6-001ade556497/resourcegroups/image/providers/Microsoft.Compute/images/vm-01-image-20220827181538"
using_source_image_reference   = true
publisher_type                 = "Canonical"
...
action_group_name        = "example-action-groupr"
short_name               = "actiongr"
action_group_rule_name   = "example-r"
scope_type               = "Resource"
activity_log_alert_name  = "example-activitylogalertr"
operation_name_log_alert = "Microsoft.Network/networkSecurityGroups/write"
category_log_alert       = "Security"
metric_alert_name        = "example-metricalertr"
