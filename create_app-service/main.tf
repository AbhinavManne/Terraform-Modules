...
module "app_service" {
  source                    = "../../modules/module_app-service-creation/app_service-module"
...
module "app_service_monitoring" {
  ...
  source                  = "../../modules/module_app-service-creation/diag_setting"
...
module "module_resource-role-assignment" {
  ...
  source = "../../modules/module_app-service-creation/rbac"
