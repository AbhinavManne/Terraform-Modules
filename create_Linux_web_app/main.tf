#--------------------------------------MODULE FOR LINUX WEB APP-------------------------------------------#
module "web_app_module" {
  source              = "../modules/module_linux_web_app/linux_web_app"
  name                = var.name
  ...
  site_config_config = [{
    ...
    application_stack = [{
      ...
      //java_server         = var.site_config_config.0.application_stack.0.java_server
      //java_server_version = var.site_config_config.0.application_stack.0.java_server_version
      //java_version        = var.site_config_config.0.application_stack.0.java_version

      docker_image     = var.site_config_config.0.application_stack.0.docker_image
      docker_image_tag = var.site_config_config.0.application_stack.0.docker_image_tag
    }]
