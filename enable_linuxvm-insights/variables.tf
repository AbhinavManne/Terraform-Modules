...
variable "storage_container" {
  type        = string
  description = "Specifies the name of the storage container. Changing this forces a new resource to be created."
}
...
variable "disable_password_authentication" {
  type        = string
  description = "Enable- disable_password_authentication "
}
...
#-------------------------------------------RESOURCE: VM EXTENSION (DISK ENCRYPTION)-----------------------#
