...
module "sql_server_virtual_machine" {
  source         = "../../modules/module_connect-windowsvm-to-log-analytics-workspace/vm_module"
...
module "vm_monitoring" {
  source                  = "../../modules/module_connect-windowsvm-to-log-analytics-workspace/diag_setting"
  resource_id             = module.sql_server_virtual_machine.log_id
...
module "module_resource-role-assignment" {
  ...
  source               = "../../modules/module_connect-windowsvm-to-log-analytics-workspace/rbac_module"
  scope                = module.sql_server_virtual_machine.log_id
