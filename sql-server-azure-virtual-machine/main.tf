...
module "sql_server_virtual_machine" {
  source         = "../../modules/module_sql-server-on-azure-vm/vm_module"
...
module "maria_db_monitoring" {
  source                  = "../../modules/module_sql-server-on-azure-vm/diag_setting"
  resource_id             = module.sql_server_virtual_machine.vm_id
...
module "module_resource-role-assignment" {
  ...
  source               = "../../modules/module_sql-server-on-azure-vm/rbac_module"
  scope                = module.sql_server_virtual_machine.vm_id
