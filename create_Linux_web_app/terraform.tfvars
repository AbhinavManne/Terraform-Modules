...
service_plan_id = "/subscriptions/dcd2c118-9f88-4a53-8b1b-fbc235ad0bef/resourceGroups/common_rg/providers/Microsoft.Web/serverfarms/test"
...
site_config_config = [{
  ...
  application_stack = [{
    ...
    //docker_image     = "azure-app-service/samples/aspnethelloworld"
...
backup_config = [{
  ...
  storage_account_url = "https://teststorew.blob.core.windows.net/test?sp=r&st=2022-11-06T14:15:55Z&se=2022-11-06T22:15:55Z&spr=https&sv=2021-06-08&sr=c&sig=RdOhZGX6DjUpAMXp8dZH0K1Qw%2BD%2FzWOs9pbrSPvSV8E%3D"
}]
...
storage_account_config = [{
   access_key    = "iTIPgUhliFyx3JyFYMqIqMdFV5sQFeaadxl0wUau9IqwoGn+awtakVUl4SunEOPrbKenoLAjn8Ud+AStd8npBg=="
     ...
     application_logs = [{
         file_system_level   = "Information"
          azure_blob_storage = [{
                level             = "Information"
                retention_in_days = 0
                sas_url           = "https://teststorew.blob.core.windows.net/test?sp=r&st=2022-11-06T14:15:55Z&se=2022-11-06T22:15:55Z&spr=https&sv=2021-06-08&sr=c&sig=RdOhZGX6DjUpAMXp8dZH0K1Qw%2BD%2FzWOs9pbrSPvSV8E%3D"
           }]
          }]
      http_logs = [{
          file_system = [{
...
//storage account - funappstgacc01
//storage account for backup - fappbackupstg
//app service plan - funappserviceplan
