module "storage" {
  ...
  source = "../../modules/module_storage-file-share-with-directory/storage-file-share"
  ...
  storage_share_file_name              = var.storage_share_file_name
  storage_share_file_source            = var.storage_share_file_source
  storage_share_directory_name         = var.storage_share_directory_name
}

#---------module for logging and monitoring--------#
module "diag_monitoring" {
  source                  = "../../modules/module_storage-file-share-with-directory/logging_and_monitoring"
...
module "module_resource-role-assignment" {
  source                  = "../../modules/module_storage-file-share-with-directory/rbac"
  resource_group_name     = module.storage.resource_group
  resource_group_id       = module.storage.resource_group_id
  resource_group_location = module.storage.resource_group_location
