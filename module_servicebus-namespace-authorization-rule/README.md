...
- namespaceauth.tf : This file is having the terraform code to provision the resource as per requirements.
...
| Name | Type |
|------|------|
| [azurerm_servicebus_namespace_authorization_rule.servicebus_namespace_authorization](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/servicebus_namespace_authorization_rule) | resource |
...
| <a name="input_listen"></a> [listen](#input\_listen) | Grants listen access to this this Authorization Rule. | `bool` | `false` | no |
...
| <a name="input_manage"></a> [manage](#input\_manage) | Grants manage access to this this Authorization Rule. When this property is true - both listen and send must be too. | `bool` | `false` | no |
...
| <a name="input_send"></a> [send](#input\_send) | Grants send access to this this Authorization Rule. | `bool` | `false` | no |
