...
variable "servicebus_topic_authorization_rule_name" {
  type        = string
  description = "Specifies the name of the ServiceBus Topic Authorization Rule resource. Changing this forces a new resource to be created."
}

variable "listen" {
  type        = bool
  default     = false
  description = "Grants listen access to this this Authorization Rule. At least one of the 3 permissions - listen, send and manage - needs to be set."
}

variable "send" {
  type        = bool
  default     = false
  description = "Grants send access to this this Authorization Rule. At least one of the 3 permissions - listen, send and manage - needs to be set."
}

variable "manage" {
  type        = bool
  default     = false
  description = "Grants manage access to this this Authorization Rule. When this property is true - both listen and send must be too. At least one of the 3 permissions - listen, send and manage - needs to be set."
}