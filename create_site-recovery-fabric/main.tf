module "site-recovery-fabric" {
  source = "../../modules/module_site-recovery-fabric/recovery fabric"
...
module "role_assignemt" {
  source                  = "../../modules/module_site-recovery-fabric/rbac"
  resource_group_name     = module.site-recovery-fabric.resource_group_name
  resource_group_id       = module.site-recovery-fabric.resource_group_id
  resource_group_location = module.site-recovery-fabric.resource_group_location
  scope                   = module.site-recovery-fabric.resource_id
...
module "diag_monitoring" {
  source                  = "../../modules/module_site-recovery-fabric/logging_and_monitoring"
  resource_group_name     = module.site-recovery-fabric.resource_group_name
  resource_group_id       = module.site-recovery-fabric.resource_group_id
  resource_group_location = module.site-recovery-fabric.resource_group_location
  storage_account_id      = module.site-recovery-fabric.storage_id
  resource_id             = module.site-recovery-fabric.resource_id
}