...
module "DNSZone_module" {
  source = "../../modules/module_DNSrecord_caa_Creation/DNS_zone"
...
module "dns_monitoring" {
  source                  = "../../modules/module_DNSrecord_caa_Creation/diag_setting"
