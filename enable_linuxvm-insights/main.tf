...
module "linux_virtual_machine" {
  source         = "../../modules/module_enable-linuxvm-insights/vm_module"
  ...
  os_disk_storage_acct_type       = var.os_disk_storage_acct_type
  caching                         = var.caching
...
module "vm_alert_monitoring" {
  source                  = "../../modules/module_enable-linuxvm-insights/diag_setting"
  resource_id             = module.linux_virtual_machine.resource_id
  storage_account_id      = module.linux_virtual_machine.storage_account_id
  resource_group_name     = module.linux_virtual_machine.resource_group
  resource_group_id       = module.linux_virtual_machine.resource_group_id
  resource_group_location = module.linux_virtual_machine.resource_group_location
}
...
module "module_resource-role-assignment" {
  ...
  #resource_group_name  =   
  source               = "../../modules/module_enable-linuxvm-insights/rbac_module"
  scope                = module.linux_virtual_machine.resource_id
