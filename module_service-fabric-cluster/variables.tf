...
variable "reliability_level" {
  type        = string
  description = "Specifies the Reliability Level of the Cluster. Possible values include None, Bronze, Silver, Gold and Platinum.The Reliability Level of the Cluster depends on the number of nodes in the Cluster: Platinum requires at least 9 VM's, Gold requires at least 7 VM's, Silver requires at least 5 VM's, Bronze requires at least 3 VM's."
}
