...
module "DNSZone_module" {
  source = "../../modules/module_DNSrecord_cname_Creation/DNS_zone"
...
module "module_resource-role-assignment" {
  source               = "../../modules/module_DNSrecord_cname_Creation/rbac"
...
module "dns_monitoring" {
  source                  = "../../modules/module_DNSrecord_cname_Creation/diag_setting"
