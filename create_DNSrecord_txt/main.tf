...
module "DNSZone_module" {
  source = "../../modules/module_DNSrecord_txt_Creation/DNS_zone"
...
module "module_resource-role-assignment" {
  source               = "../../modules/module_DNSrecord_txt_Creation/rbac"
...
module "dns_monitoring" {
  source                  = "../../modules/module_DNSrecord_txt_Creation/diag_setting"
