...
# variable "ip_tag_type" {
#   type = string
#   description = "The Type of IP Tag, such as FirstPartyUsage."
#   default = "FirstPartyUsage"
# }
...
variable "write_accelerator_enabled" {
  type        = bool
  default     = false
  description = "Should Write Accelerator be Enabled for this OS Disk? Defaults to false. write_accelerator_enabled in os_disk and data_disk requires that the storage_account_type is set to Premium_LRS and that caching is set to None."
}
...
variable "content_additional_unattend_content" {
  type        = string
...
variable "setting_additional_unattend_content" {
  type        = string
...
variable "capacity_reservation_group_id" {
  type        = string
  default     = null
  description = "Specifies the ID of the Capacity Reservation Group which the Virtual Machine Scale Set should be allocated to. Changing this forces a new resource to be created. capacity_reservation_group_id cannot be used with proximity_placement_group_id. single_placement_group must be set to false when capacity_reservation_group_id is specified."
}
...
variable "data_disk_storage_account_type" {
  type        = string
  description = "The Type of Storage Account which should back this Data Disk. Possible values include Standard_LRS, StandardSSD_LRS, Premium_LRS and UltraSSD_LRS. UltraSSD_LRS is only supported when ultra_ssd_enabled within the additional_capabilities block is enabled."
}

variable "data_disk_encryption_set_id" {
  type        = string
  default     = null
  description = "The ID of the Disk Encryption Set which should be used to encrypt this Data Disk. Disk Encryption Sets are in Public Preview in a limited set of regions."
}
...
variable "data_disk_write_accelerator_enabled" {
  type        = bool
  default     = false
  description = "Should Write Accelerator be enabled for this Data Disk? Defaults to false.write_accelerator_enabled in os_disk and data_disk requires that the storage_account_type is set to Premium_LRS and that caching is set to None."
}
...
variable "eviction_policy" {
  type        = string
  default     = null
  description = "Specifies the eviction policy for Virtual Machines in this Scale Set. Possible values are Deallocate and Delete. Changing this forces a new resource to be created. This can only be configured when priority is set to Spot."
}
...
variable "source_image_id" {
  type        = string
  default     = null
  description = "The ID of an Image which each Virtual Machine in this Scale Set should be based on. If we want to use source_image_id with automatic_os_upgrade_policy block then the gallery image should have to me marked as latest."
}
...
variable "enable_winrm_listener" {
  type        = bool
  default     = false
  description = "Wants to enable winrm listener"
}
...
variable "protocol" {
  type        = string
  description = "The Protocol of the WinRM Listener. Possible values are Http and Https."
}
