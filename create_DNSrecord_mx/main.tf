...
module "DNSZone_module" {
  source = "../../modules/module_DNSrecord_mx_Creation/DNS_zone"
...
module "dns_monitoring" {
  source                  = "../../modules/module_DNSrecord_mx_Creation/diag_setting"
