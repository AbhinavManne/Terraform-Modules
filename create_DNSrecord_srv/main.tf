...
module "DNSZone_module" {
  source = "../../modules/module_DNSrecord_srv_Creation/DNS_zone"
...
module "module_resource-role-assignment" {
  source               = "../../modules/module_DNSrecord_srv_Creation/rbac"
...
module "dns_monitoring" {
  source                  = "../../modules/module_DNSrecord_srv_Creation/diag_setting"
