...
| <a name="input_backup_frequency"></a> [backup\_frequency](#input\_backup\_frequency) | Sets the backup frequency. Must be either Daily orWeekly. | `string` | `"Daily"` | yes |
| <a name="input_backup_policy_vm_name"></a> [backup\_policy\_vm\_name](#input\_backup\_policy\_vm\_name) | Specifies the name of the Backup Policy. | `string` | `"backup"` | yes |
| <a name="input_backup_time"></a> [backup\_time](#input\_backup\_time) | The time of day to perform the backup in 24hour format. | `string` | `"23:00"` | yes |
| <a name="input_caching"></a> [caching](#input\_caching) | Specifies the caching requirements for the OS Disk. Possible values include None, ReadOnly and ReadWrite. | `string` | `"ReadWrite"` | no |
...
| <a name="input_daily_recurrence_time"></a> [daily\_recurrence\_time](#input\_daily\_recurrence\_time) | The time each day when the schedule takes effect. | `string` | `"2200"` | yes |
| <a name="input_data_disk_attachment_caching"></a> [data\_disk\_attachment\_caching](#input\_data\_disk\_attachment\_caching) | Data disk attachment caching | `string` | `"ReadWrite"` | yes |
...
| <a name="input_data_disk_storage_account_type"></a> [data\_disk\_storage\_account\_type](#input\_data\_disk\_storage\_account\_type) | Storage account type of data disk | `string` | `"Standard_LRS"` | yes |
...
| <a name="input_dependency_agent_auto_upgrade"></a> [dependency\_agent\_auto\_upgrade](#input\_dependency\_agent\_auto\_upgrade) | Specifies if the platform deploys the latest minor version update to the type\_handler\_version specified. | `string` | `"false"` | no |
| <a name="input_dependency_agent_publisher"></a> [dependency\_agent\_publisher](#input\_dependency\_agent\_publisher) | The publisher of the extension, available publishers can be found by using the Azure CLI. | `string` | `"Microsoft.Azure.Monitoring.DependencyAgent"` | yes |
| <a name="input_dependency_agent_type"></a> [dependency\_agent\_type](#input\_dependency\_agent\_type) | The type of extension, available types for a publisher can be found using the Azure CLI. | `string` | `"DependencyAgentWindows"` | yes |
| <a name="input_dependency_agent_type_handler"></a> [dependency\_agent\_type\_handler](#input\_dependency\_agent\_type\_handler) | Specifies the version of the extension to use, available versions can be found using the Azure CLI. | `string` | `"9.5"` | yes |
| <a name="input_diag_auto_upgrade_minor_version"></a> [diag\_auto\_upgrade\_minor\_version](#input\_diag\_auto\_upgrade\_minor\_version) | Specifies if the platform deploys the latest minor version update to the type\_handler\_version specified. | `string` | `"true"` | yes |
| <a name="input_diag_name"></a> [diag\_name](#input\_diag\_name) | The name of the virtual machine extension peering. | `string` | `"WindowsDiagnostics"` | yes |
| <a name="input_diag_publisher"></a> [diag\_publisher](#input\_diag\_publisher) | The publisher of the extension, available publishers can be found by using the Azure CLI. | `string` | `"Microsoft.Azure.Diagnostics"` | yes |
| <a name="input_diag_type"></a> [diag\_type](#input\_diag\_type) | The type of extension, available types for a publisher can be found using the Azure CLI. | `string` | `"IaaSDiagnostics"` | yes |
...
| <a name="input_publisher_vm"></a> [publisher\_vm](#input\_publisher\_vm) | Specifies the Publisher of the Marketplace Image this Virtual Machine should be created from. Changing this forces a new resource to be created. | `string` | `null` | no |
