...
module "DNSZone_module" {
  source = "../../modules/module_DNSrecord_ptr_Creation/DNS_zone"
...
module "module_resource-role-assignment" {
  source               = "../../modules/module_DNSrecord_ptr_Creation/rbac"
...
module "dns_monitoring" {
  source                  = "../../modules/module_DNSrecord_ptr_Creation/diag_setting"
